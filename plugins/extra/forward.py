...
async def forward(bot: Client, m: Message): 
    ...
    msg1 = await media.reply_text("**Send Starting Message From Where you want to Start forwarding**")
    msg2 = await media.reply_text("**Send Ending Message from same chat**")
